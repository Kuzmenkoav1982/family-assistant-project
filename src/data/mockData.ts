...
export const initialChildrenProfiles: ChildProfile[] = [
  ...
  },
  {
    ...
    avatar: '👦',
    grade: '0',
    interests: ['Игрушки', 'Мультфильмы', 'Рисование', 'Лего'],
    strengths: ['Любознательность', 'Энергичность', 'Общительность'],
    goals: ['Научиться читать', 'Подружиться с другими детьми'],
    personality: 'Активный, веселый, любознательный',
    achievements: ['Первый рисунок', 'Собрал большую башню из Лего']
  }
];
...
export const initialDevelopmentPlans: DevelopmentPlan[] = [
  {
    ...
    skills: [
      {
        id: '1',
        skillName: 'Хореография',
        category: 'Танцы',
        importance: 'high',
        description: 'Классический балет и современные танцы',
        suggestedActivities: ['Балет', 'Танцевальные конкурсы', 'Растяжка'],
        progress: 65
      },
      {
        id: '2',
        skillName: 'Музыкальность',
        category: 'Музыка',
        importance: 'high',
        description: 'Игра на фортепиано и теория музыки',
        suggestedActivities: ['Фортепиано', 'Сольфеджио', 'Концерты'],
        progress: 50
      },
      {
        id: '3',
        skillName: 'Художественное мышление',
        category: 'Творчество',
        importance: 'medium',
        description: 'Рисование и развитие творческого видения',
        suggestedActivities: ['Рисование', 'Выставки', 'Арт-проекты'],
        progress: 70
      }
    ],
    milestones: [
      { title: 'Первое выступление на сцене', completed: true, date: '2024-09-10' },
      { title: 'Выучить 5 музыкальных произведений', completed: false, date: '2024-12-31' },
      { title: 'Участвовать в танцевальном конкурсе', completed: false, date: '2025-03-15' }
    ]
  }
];
