...
export const initialChildrenProfiles: ChildProfile[] = [
  {
    ...
    achievements: ['Победитель олимпиады по математике', 'Лучший игрок команды', 'Создал первый робот']
  },
  {
    id: 'child-4',
    childId: '4',
    ...
    achievements: ['Диплом конкурса рисунка', 'Первое выступление на сцене']
  }
];
