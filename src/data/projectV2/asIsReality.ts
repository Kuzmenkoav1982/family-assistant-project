...
export const REAL_STRUCTURE: RealHub[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { menu: "ИИ-Диета", hub: "ИИ-Диета по данным", status: "rename" },
      { menu: "Готовые режимы", hub: "Готовые режимы питания", status: "rename" },
      { menu: "Рецепт из продуктов", hub: "Рецепт из продуктов", status: "match" },
      { menu: null, hub: "Прогресс диеты", status: "hub-only" },
      ...
      { menu: null, hub: "Семейный кошелёк", status: "hub-only" },
    ],
  },
  {
    id: "values",
    ...
    archHubId: "values",
    rows: [
      { menu: "Ценности", hub: "Ценности семьи", status: "rename" },
      { menu: "Вера", hub: "Вера", status: "match" },
      { menu: "Традиции", hub: "Традиции и культура", status: "rename" },
  ...
  },
  {
    ...
    rows: [
      ...
      { menu: "Цели", hub: "Цели семьи", status: "rename" },
  ...
  },
  {
    ...
    rows: [
      ...
      { menu: "Финграмотность", hub: "Финансовая грамотность", status: "rename" },
  ...
  },
  {
    ...
    archHubId: "household",
    rows: [
      { menu: "Покупки", hub: "Список покупок", status: "rename" },
  ...
  },
  {
    ...
    rows: [
      ...
      { menu: "Развитие", hub: "Развитие семьи", status: "rename" },
      { menu: "Психолог ИИ", hub: "Семейный психолог", status: "rename" },
  ...
  },
  {
    ...
    rows: [
      ...
      { menu: "Вакцинация", hub: "Прививки", status: "rename" },
      { menu: "Визиты к ветеринару", hub: "Ветеринар", status: "rename" },
      ...
      { menu: "Показатели здоровья", hub: "Здоровье", status: "rename" },
      { menu: "Вещи и игрушки", hub: "Вещи", status: "rename" },
      { menu: null, hub: "Обязанности", status: "hub-only" },
      { menu: "Фотоальбом", hub: "Фото", status: "rename" },
    ],
  },
  {
    id: "family-state",
