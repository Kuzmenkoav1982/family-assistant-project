                  ...
                  <AlertDescription className="text-blue-800">
                    <div className="space-y-4">
                      ...
                      <div className="pt-2 border-t border-blue-200">
                        <p className="text-sm">
                          📖 <strong>Подробнее:</strong> <a href="https://docs.poehali.dev" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Полная инструкция в документации</a>
                        </p>
                      </div>
                    </div>
                  </AlertDescription>
