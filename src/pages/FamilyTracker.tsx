        ...
        <Card className="shadow-md bg-blue-50 border-blue-200">
          ...
          {isInstructionOpen && (
            <div className="px-4 pb-4 text-blue-800 space-y-3">
              <p>
                <strong>Каждый член семьи</strong> должен открыть приложение на своём телефоне (nasha-semiya.ru), зайти в «Семейный маячок» и нажать кнопку «Включить отслеживание». Браузер запросит доступ к геолокации — нужно разрешить. После этого координаты будут отправляться автоматически каждые 10 минут — даже если свернуть браузер.
              </p>
              <p>
                <strong>Статусы на карте:</strong> Если координаты обновлялись менее 30 минут назад — статус «Онлайн» (зелёный). Если давно нет данных — «Оффлайн» (серый). Время показывается по Москве.
              </p>
              <p>
                <strong>Безопасные зоны:</strong> Создайте зоны (школа, дом, секции) — нажмите «Добавить зону», введите название и радиус, кликните на карту. При выходе из зоны придёт push-уведомление выбранным членам семьи.
              </p>
              <p>
                <strong>Уведомления о зонах:</strong> В блоке «Уведомления о зонах» справа включите тумблер напротив имени — за кем следить. Отметьте галочками, кому сообщать о выходе из зоны. Уведомления приходят мгновенно через push, Telegram или VK Мессенджер.
              </p>
              <p>
                <strong>История перемещений:</strong> Нажмите «История перемещений» — выберите члена семьи и дату. На карте отобразятся все точки за день с маршрутом и временными метками.
              </p>
              <p className="text-sm text-blue-700">
                Все данные защищены и доступны только вашей семье. Чтобы остановить отслеживание — нажмите «Остановить отслеживание».
              </p>
              <Button
                variant="outline"
                size="sm"
