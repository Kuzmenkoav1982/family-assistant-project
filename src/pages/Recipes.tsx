                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <ul className="text-sm space-y-1 list-disc list-inside">
                          <li><strong>4 способа добавления:</strong> текст, фото блюда, сканирование рецепта (OCR), по ссылке из интернета</li>
                      ...
                      <div>
                        ...
                        <ol className="text-sm space-y-1 list-decimal list-inside">
                          <li>Нажмите <strong>"Добавить рецепт"</strong> → выберите <strong>"Распознать"</strong></li>
                          <li>Сфотографируйте рецепт из книги или блокнота</li>
                          <li>Нажмите <strong>"Распознать текст"</strong> — AI прочитает фото и сам разложит его на название, состав и способ приготовления</li>
                      ...
                      <div>
                        <p className="font-medium mb-2">🔗 Как добавить рецепт по ссылке?</p>
                        <ol className="text-sm space-y-1 list-decimal list-inside">
                          <li>Нажмите <strong>"Добавить рецепт"</strong> → выберите <strong>"По ссылке"</strong></li>
                          <li>Вставьте ссылку на рецепт с любого сайта и нажмите <strong>"Загрузить"</strong></li>
                          <li>AI сам найдёт на странице название, ингредиенты и шаги приготовления</li>
                          <li>Проверьте и при необходимости отредактируйте данные</li>
                          <li>Сохраните рецепт</li>
                        </ol>
                      </div>
                      ...
                      <div className="pt-2 border-t border-orange-200">
                        <p className="text-sm italic">
                          ...
                          а добавление по ссылке — быстро сохранить понравившийся рецепт из интернета. 
