...
const SAINTS_BY_RELIGION: Record<string, SaintEntry[]> = {
  orthodox: [
    ...
    { name: 'Георгий Победоносец', title: 'Великомученик', period: '275–303', description: 'Римский воин, отказавшийся от офицерского чина ради Христа. Принял мученическую смерть. Покровитель воинов, земледельцев и путешественников. Изображён на гербе Москвы поражающим змея.', source: 'Православие.ру', sourceUrl: 'https://pravoslavie.ru/1859.html', image: `${CDN_FAITH}/4d643f3e-461a-4a33-9e16-dbebc0da526b.jpg` },
    { name: 'Флор и Лавр', title: 'Мученики', period: 'II век', description: 'Братья-каменотёсы, принявшие мученическую смерть за веру. Почитаются как покровители лошадей и домашнего скота, а также плотников и строителей. День памяти — 31 августа.', source: 'Азбука веры', sourceUrl: 'https://azbyka.ru/days/sv-flor', image: `${CDN_FAITH}/b57c290e-29e6-4fe0-b53e-83078573ec54.jpg` },
    { name: 'Косма и Дамиан', title: 'Бессребреники', period: 'III–IV век', description: 'Братья-врачи, лечившие людей и животных бесплатно во имя Христа. Покровители врачей, фармацевтов и цирюльников. Память трижды в году — в ноябре, июле и октябре.', source: 'Азбука веры', sourceUrl: 'https://azbyka.ru/days/sv-kosma-rimskij', image: `${CDN_FAITH}/a9560347-2de0-487d-b378-a5a3f5a110a4.jpg` },
    { name: 'Иоанн Богослов', title: 'Апостол', period: 'I век', description: 'Любимый ученик Христа, автор Евангелия, трёх Посланий и Апокалипсиса. Единственный из апостолов умер не мученической смертью. Покровитель писателей, богословов и иконописцев.', source: 'Православие.ру', sourceUrl: 'https://pravoslavie.ru/1853.html', image: `${CDN_FAITH}/1bf6d833-00db-4366-8eb8-edb34762096e.jpg` },
    { name: 'Петр и Феврония Муромские', title: 'Благоверные князья', period: 'XII–XIII век', description: 'Муромский князь и крестьянская девушка — символ верной христианской любви и семейного счастья. Скончались в один день и час. Покровители семьи и брака, их день — 8 июля.', source: 'Азбука веры', sourceUrl: 'https://azbyka.ru/days/sv-petr-i-fevronija', image: `${CDN_FAITH}/cdddaab9-a647-4036-9698-676f4ac47d09.jpg` },
    { name: 'Александр Невский', title: 'Благоверный князь', period: '1221–1263', description: 'Великий полководец, разбивший шведов на Неве и немцев на Чудском озере. Защитил Русь от нашествия с Запада, сохранил православную веру. Небесный покровитель Санкт-Петербурга и воинов.', source: 'Православие.ру', sourceUrl: 'https://pravoslavie.ru/1836.html', image: `${CDN_FAITH}/dae860d0-d52b-4889-aff7-7847a713d80f.jpg` },
    { name: 'Илия Пророк', title: 'Пророк', period: 'IX век до н.э.', description: 'Ветхозаветный пророк, ревнитель веры Господней. Взят на небо живым на огненной колеснице. Особо почитается на Руси. Покровитель авиации и воздушно-десантных войск (2 августа).', source: 'Азбука веры', sourceUrl: 'https://azbyka.ru/days/sv-ilija-prorok', image: `${CDN_FAITH}/48013bb8-1a93-49a7-8c9d-2ff03581fbf3.jpg` },
  ],
  catholic: [
    ...
    { name: 'Тереза из Лизьё', title: 'Святая', period: '1873–1897', description: 'Французская монахиня-кармелитка, умершая в 24 года от туберкулёза. Автор «Истории одной души». Учила «малому пути» — простоте и доверию Богу в повседневных делах. Покровительница миссионеров.', source: 'Vatican News', sourceUrl: 'https://www.vaticannews.va/ru/saints/10/01/svyataya-tereza-iz-lizye.html', image: `${CDN_FAITH}/cdddaab9-a647-4036-9698-676f4ac47d09.jpg` },
    { name: 'Игнатий Лойола', title: 'Святой', period: '1491–1556', description: 'Основатель ордена иезуитов, бывший военный. После ранения обратился к Богу. Автор «Духовных упражнений» — классики христианской молитвенной практики. Покровитель духовных упражнений и образования.', source: 'Catholic.ru', sourceUrl: 'https://catholic.ru/modules.php?name=Encyclopedia&op=content&tid=1081', image: `${CDN_FAITH}/4d643f3e-461a-4a33-9e16-dbebc0da526b.jpg` },
    { name: 'Антоний Падуанский', title: 'Святой', period: '1195–1231', description: 'Португальский монах-францисканец, великий проповедник и чудотворец. Скончался в 36 лет. Покровитель нищих и потерявших вещи. Один из самых быстро канонизированных святых в истории Церкви.', source: 'Catholic.ru', sourceUrl: 'https://catholic.ru/modules.php?name=Encyclopedia&op=content&tid=1049', image: `${CDN_FAITH}/b57c290e-29e6-4fe0-b53e-83078573ec54.jpg` },
    { name: 'Томас Мор', title: 'Святой мученик', period: '1478–1535', description: 'Лорд-канцлер Англии, отказавшийся признать Генриха VIII главой Церкви. Казнён за верность Риму. Автор «Утопии». Покровитель политиков, государственных деятелей и юристов.', source: 'Vatican News', sourceUrl: 'https://www.vaticannews.va/ru/saints/06/22/svyatoy-tomas-mor.html', image: `${CDN_FAITH}/1bf6d833-00db-4366-8eb8-edb34762096e.jpg` },
    { name: 'Иоанн Боско', title: 'Святой', period: '1815–1888', description: 'Итальянский священник, посвятивший жизнь беспризорным детям Турина. Основал орден салезианцев. Создал систему воспитания на любви, а не на наказании. Покровитель молодёжи и воспитателей.', source: 'Vatican News', sourceUrl: 'https://www.vaticannews.va/ru/saints/01/31/svyatoy-ioann-bosko.html', image: `${CDN_FAITH}/a9560347-2de0-487d-b378-a5a3f5a110a4.jpg` },
    { name: 'Мать Тереза Калькуттская', title: 'Святая', period: '1910–1997', description: 'Основательница ордена «Миссионеры милосердия». Посвятила жизнь умирающим беднякам Калькутты. Лауреат Нобелевской премии мира 1979 года. Канонизирована папой Франциском в 2016 году.', source: 'Vatican News', sourceUrl: 'https://www.vaticannews.va/ru/saints/09/05/svyataya-teresa-iz-kalkutty.html', image: `${CDN_FAITH}/dad60ad2-ed0b-4568-9b9a-6f61266c77d2.jpg` },
    { name: 'Иоанн Павел II', title: 'Святой папа', period: '1920–2005', description: 'Польский понтифик, первый папа-славянин. Сыграл ключевую роль в падении коммунизма в Европе. Объездил весь мир, встретился с миллионами верующих. Канонизирован в 2014 году.', source: 'Vatican News', sourceUrl: 'https://www.vaticannews.va/ru/pope/news/2014-04/svyatoy-ioann-pavel-ii.html', image: `${CDN_FAITH}/af35f894-202f-4a4d-a05e-ca3435dac5f0.jpg` },
    { name: 'Бенедикт Нурсийский', title: 'Святой', period: '480–547', description: 'Отец западного монашества, основатель Монтекассино. Составил «Устав», по которому живут бенедиктинцы по сей день. Покровитель Европы и студентов. Его девиз — «Молись и трудись».', source: 'Catholic.ru', sourceUrl: 'https://catholic.ru/modules.php?name=Encyclopedia&op=content&tid=1056', image: `${CDN_FAITH}/e2ffa98d-a5c7-4bc9-b54d-7dc34d6d3129.jpg` },
  ],
  protestant: [
  ...
  islam: [
    ...
    { name: 'Пророк Ибрахим (Авраам)', title: 'Пророк', period: 'XXI–XX вв. до н.э.', description: 'Отец монотеизма, почитаемый в исламе как «халиль Аллах» — друг Бога. Построил Каабу вместе с сыном Исмаилом. Прошёл испытание готовностью принести сына в жертву.', source: 'Islam.ru', sourceUrl: 'https://islam.ru/content/history/prorok-ibrahim', image: `${CDN_FAITH}/93144984-d53b-49d4-a83b-a64f85104943.jpg` },
    { name: 'Пророк Иса (Иисус)', title: 'Пророк', period: 'I век', description: 'В исламе — один из величайших пророков, рождённый от девы Марьям (Марии). Наделён чудесами от Аллаха. Почитается как Мессия, но не как Сын Божий — это принципиальное отличие от христианства.', source: 'Islam.ru', sourceUrl: 'https://islam.ru/content/history/prorok-isa', image: `${CDN_FAITH}/deebec2e-9df7-4239-aed1-35148c6334f2.jpg` },
    { name: 'Пророк Муса (Моисей)', title: 'Пророк', period: 'XIII в. до н.э.', description: 'В исламе — один из пяти величайших пророков («улюль-азм»). Получил Таурат (Тору) от Аллаха. Вывел израильтян из Египта. Наиболее часто упоминаемый пророк в Коране.', source: 'Islam.ru', sourceUrl: 'https://islam.ru/content/history/prorok-musa', image: `${CDN_FAITH}/cdd4ae36-b1b8-48c8-8c74-8b39a5ef769a.jpg` },
    { name: 'Имам Али ибн Аби Талиб', title: 'Имам, халиф', period: '599–661', description: 'Двоюродный брат и зять пророка Мухаммада ﷺ, четвёртый праведный халиф. В шиизме — первый имам и духовный лидер. Известен мудростью, красноречием и справедливостью.', source: 'Islam.ru', sourceUrl: 'https://islam.ru/content/history/ali-ibn-abi-talib', image: `${CDN_FAITH}/f0cc1db3-dddd-4fbb-a153-1eee1603cc46.jpg` },
    { name: 'Ибн Сина (Авиценна)', title: 'Учёный, философ', period: '980–1037', description: 'Персидский учёный, «принц врачей». Автор «Канона врачебной науки» — главного медицинского труда средневековья. Философ, поэт и богослов. Оказал огромное влияние на европейскую медицину.', source: 'Islam.ru', sourceUrl: 'https://islam.ru/content/history/avicenna', image: `${CDN_FAITH}/0f93b052-8686-44a9-8264-3eb27d42b386.jpg` },
    { name: 'Хасан аль-Басри', title: 'Богослов, аскет', period: '642–728', description: 'Один из величайших ранних исламских богословов и аскетов. Современник сподвижников пророка. Учил о важности искреннего покаяния, богобоязненности и отречения от мирского.', source: 'Islam.ru', sourceUrl: 'https://islam.ru/content/history/hasan-al-basri', image: `${CDN_FAITH}/e84fd847-15a2-4327-a550-b0c3e7efc93d.jpg` },
  ],
  judaism: [
    ...
    { name: 'Авраам (Авраам-авину)', title: 'Праотец', period: 'XXI–XX вв. до н.э.', description: 'Первый еврей и праотец еврейского народа. Первым познал единого Бога в мире идолопоклонства. Прошёл десять испытаний, включая жертвоприношение сына Ицхака. «Отец верующих» в трёх религиях.', source: 'Toldot.com', sourceUrl: 'https://toldot.com/Abraham.html', image: `${CDN_FAITH}/93144984-d53b-49d4-a83b-a64f85104943.jpg` },
    { name: 'Давид (Мелех Давид)', title: 'Царь, пророк', period: 'X в. до н.э.', description: 'Второй царь Израиля, объединивший народ и основавший Иерусалим как столицу. Автор большинства Псалмов. Предок Мессии. Символ царской власти и духовной глубины еврейского народа.', source: 'Toldot.com', sourceUrl: 'https://toldot.com/David.html', image: `${CDN_FAITH}/d9f2a757-c6fc-4907-b163-7a813abd344f.jpg` },
    { name: 'Рабби Акива', title: 'Таннай, мудрец', period: '50–135 н.э.', description: 'Один из величайших мудрецов Мишны. Стал учёным в 40 лет. Систематизировал Галаху. Погиб мучеником при римлянах, умирая с молитвой «Шма Исраэль» на устах. Символ любви к Торе.', source: 'Toldot.com', sourceUrl: 'https://toldot.com/RabbiAkiva.html', image: `${CDN_FAITH}/cdd4ae36-b1b8-48c8-8c74-8b39a5ef769a.jpg` },
    { name: 'Рамбан (Нахманид)', title: 'Раввин, каббалист', period: '1194–1270', description: 'Герона Нахманид — великий испанский раввин, комментатор Торы и Талмуда, каббалист. Участник знаменитого Барселонского диспута. В старости переселился в Землю Израиля, основал синагогу в Акко.', source: 'Toldot.com', sourceUrl: 'https://toldot.com/Nachmanides.html', image: `${CDN_FAITH}/d9f2a757-c6fc-4907-b163-7a813abd344f.jpg` },
    { name: 'Рабби Нахман из Брацлава', title: 'Хасидский ребе', period: '1772–1810', description: 'Правнук Бааль Шем Това, основатель брацлавского хасидизма. Автор глубоких притч и историй о Боге и человеке. Учил, что главное — никогда не отчаиваться. Его хасиды ежегодно едут в Умань.', source: 'Toldot.com', sourceUrl: 'https://toldot.com/NachmanBreslov.html', image: `${CDN_FAITH}/93144984-d53b-49d4-a83b-a64f85104943.jpg` },
    { name: 'Хафец Хаим (Исраэль Кохен)', title: 'Раввин, законоучитель', period: '1838–1933', description: 'Один из самых почитаемых еврейских мудрецов XX века. Прославился книгой «Хафец Хаим» о запрете злословия (лашон а-ра). Основал Радинскую ешиву. Олицетворение еврейской праведности.', source: 'Toldot.com', sourceUrl: 'https://toldot.com/ChafetzChaim.html', image: `${CDN_FAITH}/cdd4ae36-b1b8-48c8-8c74-8b39a5ef769a.jpg` },
  ],
  buddhism: [
...
const ICONS_DATA: { name: string; description: string; feast: string; prayer: string; source: string; sourceUrl: string; image: string }[] = [
  ...
  { name: 'Смоленская икона Божией Матери «Одигитрия»', description: 'Одна из древнейших икон России, по преданию написана евангелистом Лукой. Одигитрия означает «Путеводительница». Почиталась как главная защитница западных рубежей России.', feast: '10 августа', prayer: 'О Пресвятая Богородице, Небесная Царице! Ты путеводиши нас по жизни сей многоскорбней, помози нам достигнути пристани спасения.', source: 'Азбука веры', sourceUrl: 'https://azbyka.ru/days/ikona-smolenskaja', image: `${CDN_FAITH}/b0f5cf7c-29df-408e-a505-6ca9875f10be.jpg` },
  { name: 'Донская икона Божией Матери', description: 'По преданию, подарена донскими казаками Дмитрию Донскому перед Куликовской битвой. Дважды спасала Москву от татарских набегов. Хранится в Государственной Третьяковской галерее.', feast: '1 сентября', prayer: 'О Владычице Богородице, Заступнице наша! Тебе вручаем судьбу нашу и просим покрыти нас от всех бед и напастей.', source: 'Православие.ру', sourceUrl: 'https://pravoslavie.ru/2084.html', image: `${CDN_FAITH}/004165ec-ff86-4a5b-acd4-24cc1983ef37.jpg` },
  { name: 'Феодоровская икона Божией Матери', description: 'Родовая икона дома Романовых. По ней в 1613 году благословили на царство Михаила Романова. Почитается как покровительница семьи, материнства и невест. Хранится в Костроме.', feast: '14 марта / 29 августа', prayer: 'О Пресвятая Богородице, помози нам, грешным, в устроении семьи нашей, да живём в мире и любви, в радости и согласии.', source: 'Азбука веры', sourceUrl: 'https://azbyka.ru/days/ikona-feodorovskaja', image: `${CDN_FAITH}/f7df3aea-892f-4498-95ae-ee0542e23882.jpg` },
  { name: 'Икона «Всех скорбящих Радость»', description: 'Прославилась чудесами с 1688 года в Москве. Особо почитается страждущими и больными. Одна из самых любимых икон городской России. Богородица изображена окружённой ангелами и скорбящими людьми.', feast: '6 ноября', prayer: 'О Пресвятая Богородице, Утешительнице скорбящих! Призри на нас грешных и обременённых скорбями, и защити нас от всех бед.', source: 'Правикон', sourceUrl: 'https://pravicon.com/icon-60', image: `${CDN_FAITH}/ad6bc530-5c0c-4de9-bf25-01a5419a7964.jpg` },
  { name: 'Почаевская икона Божией Матери', description: 'Главная святыня Успенской Почаевской лавры на Украине. Почитается с XIV века. По преданию, на горе явилась Богородица, и на камне остался отпечаток её стопы.', feast: '23 июля / 21 сентября', prayer: 'О Пречудная Мати Почаевская! Приими молитвы наша и вознеси их ко Господу, да подаст нам прощение грехов и помощь в скорбях.', source: 'Православие.ру', sourceUrl: 'https://pravoslavie.ru/2109.html', image: `${CDN_FAITH}/b51b1888-5a20-4227-acf5-2784712c27c6.jpg` },
  { name: 'Икона святителя Николая Чудотворца', description: 'Наиболее распространённый иконографический тип святого Николая. Почитается как заступник путешественников, моряков, торговцев и детей. Одна из самых любимых икон на Руси.', feast: '19 декабря / 22 мая', prayer: 'О Всесвятый Николае, угодниче преизрядный Господень! Услыши нас грешных, молящихся тебе и испроси нам у Христа Бога нашего вся благопотребная.', source: 'Азбука веры', sourceUrl: 'https://azbyka.ru/days/sv-nikolaj-mirlikijskij', image: `${CDN_FAITH}/fa9d44b9-704d-4723-996c-67295c69aa85.jpg` },
  { name: 'Икона «Державная»', description: 'Явлена в 1917 году в день отречения Николая II от престола. Богородица изображена как царица с державой и скипетром. Почитается как знак особого покровительства Богородицы над Россией.', feast: '15 марта', prayer: 'О Державная Владычице, Пресвятая Богородице! Приими молитву нас грешных рабов Твоих и сохрани страну нашу под державным покровом Твоим.', source: 'Православие.ру', sourceUrl: 'https://pravoslavie.ru/1974.html', image: `${CDN_FAITH}/d2a017f5-8125-42a7-8a21-c211555f4019.jpg` },
];
