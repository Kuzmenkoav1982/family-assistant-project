...
export default function Notifications() {
  ...
  const getMeta = (type: string) =>
    TYPE_META[type] || { icon: 'Bell', color: 'text-gray-500 bg-gray-50', label: type };
  ...
  return (
    <SectionPageFrame
      ...
      variant="light"
      width="narrow"
      backgroundClass="bg-gradient-to-br from-gray-50 to-blue-50/30 dark:from-gray-950 dark:via-gray-900 dark:to-gray-900"
      rightAction={
        unreadCount > 0 ? (
            ...
            return (
              <Card
                ...
                className={`p-4 cursor-pointer transition-all hover:shadow-md ${
                  isUnread ? 'bg-white border-l-4 border-l-blue-500 shadow-sm' : 'bg-white/70 dark:bg-gray-800/70'
                }`}
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className={`text-sm font-semibold ${isUnread ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400'}`}>
                        {n.title}
                      </span>
