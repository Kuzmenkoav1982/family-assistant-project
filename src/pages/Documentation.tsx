      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <Card id="access" className="p-8 mb-6 scroll-mt-8 border border-gray-200">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p>
              Для ознакомления с функциональными возможностями программного обеспечения
              без регистрации предусмотрен демонстрационный режим:
            </p>
            <ol className="list-decimal list-inside space-y-2 ml-2">
              <li>Откройте веб-браузер и перейдите по адресу: <strong>https://nasha-semiya.ru</strong></li>
              <li>На главной странице нажмите кнопку «Смотреть демо».</li>
              <li>
                Выберите один из доступных вариантов демонстрационного режима.
              </li>
              <li>
                После перехода в демонстрационный режим пользователю предоставляется
                доступ к экземпляру программного обеспечения с предзаполненными
                демонстрационными данными. Регистрация не требуется.
              </li>
            </ol>
            <p>
              В правом верхнем углу интерфейса отображается индикатор «Гостевой просмотр»,
              подтверждающий работу в демонстрационном режиме.
            </p>
            <p>
              Для завершения работы закройте вкладку браузера или выберите команду «Выйти»
