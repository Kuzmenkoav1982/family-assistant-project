        ...
        <Card id="access" className="p-8 mb-6 scroll-mt-8 border border-gray-200">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <ol className="list-decimal list-inside space-y-2 ml-2">
              ...
              <li>
                Выберите режим просмотра: «Экскурсия с гидом» (пошаговый тур)
                или «Свободный режим» (полный доступ к демонстрационным данным).
              </li>
              <li>
                После входа в демонстрационный режим обеспечивается доступ
                к функциональным возможностям сервиса с предзаполненными
