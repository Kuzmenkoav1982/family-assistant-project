...
const videos = [
  {
    id: 0,
    title: '«Наша Семья» — сильная семья, сильная страна',
    description: 'Рекламный ролик платформы «Наша Семья». Семья — основа общества и государства. Когда семья сильна — сильна страна. Присоединяйтесь к движению за крепкие, счастливые семьи.',
