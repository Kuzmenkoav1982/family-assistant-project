...
const cards: RouteCard[] = [
  {
    ...
    title: 'ЦСИ × Наша семья',
    description:
      'Цифровое продолжение семейной истории. Рабочая концепция для первого обсуждения со Спартаком — не согласованное партнёрство. 8 экранов + 2 в приложении.',
    href: '/strategy/csi',
    extra: [{ label: 'Режим встречи', href: '/strategy/csi?mode=meeting' }],
    tone: 'primary',
  },
  {
    group: 'Открывать первым',
    title: 'Детская карта × Наша семья',
    description:
      'Совместный продукт для банка: детская карта + модуль развития ребёнка. 15 экранов. Ярославская область, 2026.',
    href: '/bank-deck',
    extra: [{ label: 'Режим встречи', href: '/bank-deck?mode=meeting' }],
    tone: 'primary',
  },
  {
    group: 'Открывать первым',
    title: 'А7 × Наша семья',
    description:
      'Стратегическая инвестиция в семейный цифровой фронт-офис для А7 — 4 направления партнёрства, пилот «А7 Семейные цели», инвестиционная модель. 18 экранов.',
    href: '/a7-deck',
    extra: [{ label: 'Режим встречи', href: '/a7-deck?mode=meeting' }],
    tone: 'primary',
  },
  {
    group: 'Открывать первым',
