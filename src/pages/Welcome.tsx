...
export default function Welcome() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="Наша Семья — семейное приложение, планировщик и органайзер для всей семьи. Семейная ОС: дела, дети, здоровье, бюджет в одном месте"
        description="Семейное приложение для всей семьи: планировщик дел, семейный органайзер, календарь, бюджет, здоровье детей, списки покупок и меню на неделю. Это Семейная ОС — единая платформа, где живут профили, отношения, договорённости и смыслы. AI-помощник «Домовой», GPS-маячок семьи, медкарты, чат семьи, Яндекс Алиса. Мобильное приложение для семейного планирования бесплатно — оплата только за AI-функции. Данные хранятся в России. Работает в браузере, на смартфоне и планшете. Для 0+."
        path="/"
      />
