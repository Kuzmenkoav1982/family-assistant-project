  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        ...
        description="Семейное приложение для планирования дел. Российское ПО из реестра Минцифры (запись №34764). Удобный сервис для планирования ✔️здоровье, питание, бюджет, развитие детей ✔️AI-помощник и Яндекс Алиса. Список дел и покупок 📱 Скачайте бесплатно для 4 пользователей. Работает на смартфоне, планшете и компьютере. Для 0+."
        path="/"
      />
