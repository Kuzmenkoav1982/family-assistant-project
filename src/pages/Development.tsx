...
export default function Development() {
  ...
  return (
    <>
    <SEOHead title="Развитие — психологические тесты и рост" description="Психологические тесты для семьи: эмоциональный интеллект, стиль общения, разрешение конфликтов, управление стрессом. Отслеживайте прогресс развития." path="/development" />
