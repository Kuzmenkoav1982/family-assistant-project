...
const SALE_SLIDES = [
  {
    ...
    subtitle: '"Наша Семья" — M&A стратегия · Май 2026',
  ...
  },
  {
    ...
    blocks: [
      ...
      { label: '#2 Сбер / СберПрайм', value: '100–200 млн руб. · Дополняет экосистему СберПрайм Семья · 100M+ клиентов · Высокий интерес к семейной теме' },
      { label: '#3 Т-Банк', value: '80–150 млн руб. · Lifestyle-экосистема · Аудитория 25–40 лет · Нет семейного продукта' },
  ...
  },
  {
    ...
    subtitle: 'Май 2026 — Январь 2027 · Целевая дата закрытия',
    bg: '134E4A', accent: '99F6E4',
    tag: 'ДОРОЖНАЯ КАРТА M&A',
    blocks: [
      { label: 'Май–Июнь 2026', value: 'Подготовка: ООО, ТМ, тизер, IM, NDA, список покупателей, VDR, финансовая документация' },
      { label: 'Июль–Август 2026', value: 'Первые контакты: тизеры в ПСБ, Сбер, Т-Банк, VK, Яндекс · Цель: 5+ NDA · 2–3 активных диалога' },
      { label: 'Сентябрь–Октябрь 2026', value: 'LOI от 1–2 покупателей · Открытие VDR · Технический + юридический + финансовый Due Diligence' },
      { label: 'Ноябрь–Декабрь 2026', value: 'Финальные переговоры · Выбор покупателя · Согласование earn-out · Финальный договор с юристами' },
      { label: 'Январь 2027', value: 'Закрытие сделки · Подписание договора · Передача активов · Получение оплаты 80–250 млн руб.' },
    ]
  },
  {
    type: 'table' as const,
