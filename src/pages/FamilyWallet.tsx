...
export default function FamilyWallet() {
  ...
  return (
    <>
    <SEOHead title="Семейный кошелёк — баланс и операции" description="Баланс семейного кошелька, история операций, пополнение счёта для использования ИИ-сервисов." path="/wallet" />
