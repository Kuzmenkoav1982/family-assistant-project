...
const subSections: SubSection[] = [
  ...
  },
  {
    ...
    description: 'Персональные сценарии после ссор на основе языков любви и психотипов членов семьи',
    icon: 'Flame',
  ...
  },
  {
    id: 'child-code',
    title: 'Детский код',
    description: 'Особый расчёт для детей: врождённые таланты, склонности и рекомендации для родителей',
    icon: 'Baby',
  ...
  },
  {
    ...
    description: 'Калькулятор нумерологической совместимости имени будущего ребёнка с родителями',
    icon: 'Sparkles',
