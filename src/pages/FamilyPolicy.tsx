...
const policyDirections: PolicyDirection[] = [
  {
    ...
    achievements: [
      ...
      'Повышение рождаемости в 2023 году на 1,2%'
    ],
    goals: [
  ...
  },
  {
    ...
    achievements: [
      ...
      'Более 120 тыс. семей улучшили жилищные условия в 2023'
    ],
    goals: [
  ...
  },
  {
    ...
    goals: [
      'Обеспечение местами в детсадах всех детей от 1,5 лет к 2025',
