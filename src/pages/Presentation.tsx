  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      <div id="presentation-content" className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="bg-white rounded-3xl shadow-xl p-10 mb-8 border-4 border-orange-200">
          <div className="flex items-center gap-4 mb-8">
            <Icon name="Baby" className="text-orange-500" size={48} />
            <div>
              <h2 className="text-3xl font-bold text-gray-800">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl p-5 shadow-sm border-l-4 border-orange-400">
                  <div className="flex items-start gap-3">
                    <Icon name="AlertCircle" className="text-orange-500 mt-1" size={24} />
                    <div>
                      <h4 className="font-bold text-gray-800 mb-1">Пример: Низкая самостоятельность</h4>
                      <p className="text-sm text-gray-600 mb-3">
                        "Максим (8 лет) всегда просит помощи даже в простых задачах"
                      </p>
                      <div className="bg-orange-50 rounded-lg p-3">
                        <p className="text-sm font-semibold text-orange-800 mb-2">💡 Рекомендации ИИ:</p>
                ...
                <div className="bg-white rounded-xl p-5 shadow-sm border-l-4 border-pink-400">
                  <div className="flex items-start gap-3">
                    <Icon name="Heart" className="text-pink-500 mt-1" size={24} />
                    <div>
                      <h4 className="font-bold text-gray-800 mb-1">Пример: Эмоциональные вспышки</h4>
                      <p className="text-sm text-gray-600 mb-3">
                        "София (6 лет) часто плачет и срывается, когда что-то не получается"
                      </p>
                      <div className="bg-pink-50 rounded-lg p-3">
                        <p className="text-sm font-semibold text-pink-800 mb-2">💡 Рекомендации ИИ:</p>
                        <ul className="text-sm text-gray-700 space-y-1 ml-4">
            ...
            <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-2xl p-8 border-2 border-green-200">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-white rounded-xl p-5 text-center shadow-sm">
                  <Icon name="BarChart3" className="text-green-500 mx-auto mb-3" size={32} />
                  <h4 className="font-bold text-gray-800 mb-2">Графики прогресса</h4>
                  <p className="text-sm text-gray-600">
                    Наглядная динамика по каждой компетенции за месяц, квартал, год
                  </p>
                </div>
                <div className="bg-white rounded-xl p-5 text-center shadow-sm">
                  <Icon name="Calendar" className="text-blue-500 mx-auto mb-3" size={32} />
                  <h4 className="font-bold text-gray-800 mb-2">План развития</h4>
                  <p className="text-sm text-gray-600">
                    Расписание активностей и заданий для гармоничного роста
                  </p>
                </div>
                <div className="bg-white rounded-xl p-5 text-center shadow-sm">
                  <Icon name="Award" className="text-yellow-500 mx-auto mb-3" size={32} />
                  <h4 className="font-bold text-gray-800 mb-2">Достижения</h4>
                  <p className="text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl p-8 text-white text-center">
              <Icon name="Rocket" className="mx-auto mb-4" size={48} />
