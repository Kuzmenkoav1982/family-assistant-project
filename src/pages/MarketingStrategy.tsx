...
const STRATEGY_SLIDES: AnySlide[] = [
  {
    ...
    tag: 'Версия 1.2 · Май 2026 · Конфиденциально',
    blocks: [
      ...
      { label: 'MRR цель', value: '~2,8 млн руб./мес к марту 2028' },
    ]
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Ежеквартальные цели март 2027 — март 2028',
    bg: 'B45309', accent: 'FDE68A',
    tag: 'Метрики',
    blocks: [
      { label: 'Q1 2027 · Март–Май', value: '300 активных платящих семей · MRR ~84 000 руб. · NPS > 50 · CAC < 600 руб.' },
      { label: 'Q2 2027 · Июнь–Август', value: '2 000 семей · MRR ~560 000 руб. · CAC < 400 руб. · LTV/CAC > 3' },
      { label: 'Q3 2027 · Сентябрь–Ноябрь', value: '5 000 семей · MRR ~1,4 млн руб. · Churn < 5% · Breakeven' },
      { label: 'Q4 2027 · Декабрь–Март 2028', value: '10 000 семей · MRR ~2,8 млн руб. · ARR ~33,6 млн руб.' },
      { label: 'North Star Metric', value: 'Активных платящих семей (с пополненным кошельком) — целевое значение 10 000 к марту 2028' },
    ]
  },
  {
    title: 'SWOT-анализ',
    ...
    blocks: [
      ...
      { label: 'Возможности', value: 'Стратегия семейной политики РФ до 2036 года · Господдержка · B2B с банками · Выход в СНГ' },
      { label: 'Угрозы', value: 'Копирование идеи Сбером / VK · Высокий CAC · Регуляторные риски (персданные детей)' },
    ]
  },
  {
    title: 'Роадмап 2027–2028',
    subtitle: 'От 88 семей к 10 000 платящих',
    bg: '0F172A', accent: '7DD3FC',
    tag: 'Дорожная карта',
    blocks: [
      { label: 'Q1 2027 · Март–Май', value: 'Запуск рекламных каналов · Партнёрства с 3–5 клиниками · Реферальная программа · 300 семей' },
      { label: 'Q2 2027 · Июнь–Август', value: 'iOS-приложение · Масштаб ВКонтакте до 40K/мес · Переговоры с ПСБ · 2 000 семей' },
      { label: 'Q3 2027 · Сентябрь–Ноябрь', value: 'Android-приложение · Корпоративный тариф · Пилот с ПСБ 50K семей · 5 000 семей' },
      { label: 'Q4 2027 · Декабрь–Март 2028', value: 'Series A или стратегическая продажа · Выход в Казахстан, Беларусь · 10 000 семей' },
  ...
  },
  {
    ...
    bars: [
      { label: 'Q1: Март–Май 2027', value: 84, max: 2800, color: '6EE7B7' },
      { label: 'Q2: Июнь–Август 2027', value: 560, max: 2800, color: '34D399' },
      { label: 'Q3: Сент–Ноябрь 2027', value: 1400, max: 2800, color: '10B981' },
      { label: 'Q4: Дек 2027 – Март 2028', value: 2800, max: 2800, color: '059669' },
    ],
    note: 'ARR к марту 2028: ~33 600 000 руб. · Breakeven в Q3 2027 · ROI маркетинга: >300%',
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div ref={contentRef} className="max-w-6xl mx-auto px-6 py-10 space-y-8">
        ...
        {active === 'roadmap' && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-slate-500">Поквартальный план действий, март 2027 — март 2028</p>
            </div>

            <div className="space-y-5">
              {[
                {
                  period: 'Q1 2027 · Март – Май', subtitle: 'Фундамент и первые 300 платящих семей',
                  color: 'border-blue-400 bg-blue-50', badge: 'bg-blue-600', status: 'Старт 05.03.2027',
                ...
                {
                  period: 'Q2 2027 · Июнь – Август', subtitle: 'Масштаб и 2 000 платящих семей',
                ...
                {
                  period: 'Q3 2027 · Сентябрь – Ноябрь', subtitle: 'B2B и 5 000 платящих семей',
                ...
                {
                  period: 'Q4 2027 · Декабрь – Март 2028', subtitle: 'Series A-ready: 10 000 платящих семей',
        ...
        <div className="text-center text-xs text-slate-400 pt-4 pb-8">
          «Наша Семья» · Маркетинговая стратегия v1.2 · 04.05.2026 · Конфиденциально
        </div>
      </div>
