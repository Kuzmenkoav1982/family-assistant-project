                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-xs leading-relaxed">
                      Финансовый хаб объединяет все инструменты: бюджет, счета, долги, цели, аналитику,
                      регулярные платежи, имущество, скидочные карты и антимошенник. Начните с добавления
                      счетов и настройки бюджета — остальные модули подключатся автоматически.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ol className="text-xs space-y-0.5 ml-4 list-decimal">
                      ...
                      <li>Запустите аналитику — ИИ оценит здоровье ваших финансов</li>
                    </ol>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white/50 p-2 rounded-lg">
                    <p className="text-xs">
                      ...
                      (10% дохода) может сократить срок кредита на годы.
                    </p>
                  </div>
