            ...
            <CollapsibleContent className="mt-3 space-y-3">
              <AlertDescription className="text-indigo-800">
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="font-medium mb-1 text-sm">План досрочных платежей (бонус/премия)</p>
                    <ol className="text-xs space-y-0.5 ml-4 list-decimal">
                      <li>Укажите свободную сумму — например, премию или 13-ю зарплату</li>
                      <li>Выберите приоритет: «Меньше переплата» (по ставке), «Легче платить» (снижение платежа) или «Быстрый результат» (снежный ком)</li>
                      <li>Распределите бюджет по долгам вручную или одним касанием «Закрыть полностью»</li>
                      <li>Система покажет экономию и новый ежемесячный платёж после досрочного погашения</li>
                    </ol>
                  </div>
