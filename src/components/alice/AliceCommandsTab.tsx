...
export function AliceCommandsTab() {
  const commandGroups = [
    ...
    },
    {
      ...
      commands: [
        { text: 'Добавь в список покупок молоко, хлеб и яйца', desc: 'Добавить несколько товаров (каждый в отдельный слот)' },
        { text: 'Добавь в список покупок масло', desc: 'Добавить один товар' },
        { text: 'Что в списке покупок?', desc: 'Показать список' },
        { text: 'Покажи список покупок', desc: 'Альтернативный вариант' },
      ]
    },
    {
      title: 'Информация',
