                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <ol className="text-xs space-y-0.5 list-decimal list-inside">
                      ...
                      <li>Установите дату и время выполнения</li>
                      <li>Выберите исполнителя из семьи</li>
                      <li>Задайте баллы и категорию</li>
                      <li>Для регулярных дел включите «Повтор» и настройте расписание</li>
                    </ol>
                  </div>
                  <div>
                    <p className="font-medium mb-1 text-sm">✏️ Редактирование</p>
                    <p className="text-xs">Нажмите на карандаш справа от задачи — откроется форма, где можно изменить любое поле, включая дату, время и повтор.</p>
                  </div>
                  <div>
                    <p className="font-medium mb-1 text-sm">🔔 Уведомления</p>
                    <p className="text-xs">Система автоматически напомнит о задачах: за сутки до срока и при просрочке. Настроить уведомления можно в разделе «Уведомления».</p>
                  </div>
                  <div>
                    <p className="font-medium mb-1 text-sm">⏰ Сроки</p>
                    <p className="text-xs">Задачи с дедлайном показывают оставшееся время (Сегодня, Завтра, дата). Просроченные задачи выделяются красным.</p>
                  </div>
                  <div className="pt-2 border-t border-blue-200">
                    <p className="text-xs italic">
                      💡 <strong>Совет:</strong> Назначайте дату и время для важных дел — так система вовремя напомнит ответственному о выполнении.
                    </p>
                  </div>
                </div>
              </AlertDescription>
