...
const benefits = [
  ...
  {
    emoji: '📚',
    title: 'Образовательный контент (этап 2)',
    desc: 'В перспективе — книги, аудиокниги, подборки по интересам через партнёрскую интеграцию',
  },
  {
    emoji: '🤝',
  ...
  {
    emoji: '🐻',
    title: 'Знакомство с родным краем',
    desc: 'Факты о Ярославской области, мини-квиз и идеи для семейных прогулок — ребёнок чувствует связь с регионом',
  },
];
