...
const benefits = [
  ...
  },
  {
    ...
    desc: 'Доступ к инструментам платформы: развитие, здоровье, безопасность ребёнка, семейные сценарии',
  },
  {
    emoji: '🛡️',
    title: 'Больше спокойствия',
    desc: 'Ребёнок знает как действовать в важных ситуациях: пожар, мошенники, интернет — прямо в его кабинете',
  },
  {
    emoji: '🐻',
    title: 'Полезный локальный контент',
    desc: 'Ребёнок изучает родной край через факты и квизы, семья получает идеи для совместного досуга в регионе',
  },
];
