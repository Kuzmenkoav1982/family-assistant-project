...
const SCREENS = [
  ...
  },
  {
    ...
    children: [
      ...
      'safety_test_start / finish / level',
...
const HONEST_TABLE = [
  ...
  { item: 'Аналитика идёт в собственный трекер', note: '17 событий уже подключены. Видно что и когда открывают.' },
  { item: 'Возрастная адаптация не сделана', note: 'Один вариант текста для 7–15 лет — следующий продуктовый шаг.' },
