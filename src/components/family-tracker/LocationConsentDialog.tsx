...
const REASON_TEXT: Record<string, string> = {
  SUBJECT_AGE_UNKNOWN:
    'Не указана дата рождения участника. Пока возраст неизвестен, мы не можем определить, кто вправе дать согласие, и не включаем геолокацию.',
  LOCATION_AGE_UNKNOWN:
    'Не указана дата рождения участника. Пока возраст неизвестен, мы не можем определить, кто вправе дать согласие, и не включаем геолокацию.',
  SELF_CONSENT_ONLY:
    'С 14 лет решение принимает сам участник. Вы можете отправить запрос, но подтвердить его должен он через свой аккаунт.',
  SUBJECT_HAS_NO_ACCOUNT:
    'С 14 лет согласие даёт сам участник, но у него нет собственного аккаунта. Пока аккаунта нет, функцию включить нельзя — за него это сделать некому.',
  // Ключевая формулировка: система говорит о ЗАЯВЛЕНИИ, а не о проверке.
  REPRESENTATION_NOT_DECLARED:
    'Для участника младше 14 лет решение принимает законный представитель. Сначала нужно заявить, что вы им являетесь. Роли «родитель», «владелец» и «администратор» сами по себе этого не подтверждают.',
  REPRESENTATION_REVOKED:
    'Ваше заявление о законном представительстве отозвано. Чтобы снова принимать решения за этого участника, сделайте заявление заново.',
  REPRESENTATIVE_AGE_UNKNOWN:
    'Не указана ваша дата рождения. Решение за ребёнка может принимать только совершеннолетний, поэтому возраст нужно указать.',
  REPRESENTATIVE_NOT_ADULT:
    'Решение об обработке данных ребёнка может принимать только совершеннолетний представитель.',
  LEGAL_REPRESENTATIVE_NOT_CONFIRMED:
    'Для участника младше 14 лет решение принимает законный представитель. Сначала нужно заявить, что вы им являетесь.',
