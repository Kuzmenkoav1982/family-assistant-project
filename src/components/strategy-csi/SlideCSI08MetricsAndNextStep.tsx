...
const metrics = [
  ...
  'сколько добавили родственников',
  'сколько описали фотографию',
  'сколько сохранили семейную историю',
  'сколько вовлекли второго родственника',
  'сколько вернулись через 7 и 30 дней',
  'сколько завершили маршрут',
  'насколько понятны методические материалы',
  'сколько захотели продолжить работу с ЦСИ',
  'сколько добровольно предложили отдельные материалы Центру',
];
