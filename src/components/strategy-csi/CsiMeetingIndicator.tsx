...
export default function CsiMeetingIndicator({
  activeIndex,
  total,
  onPrev,
  onNext,
  onExit,
}: CsiMeetingIndicatorProps) {
  return (
    <div
      data-meeting-indicator
      className="fixed top-3 right-3 z-[60] flex items-center gap-2 bg-stone-900/90 backdrop-blur-md border border-amber-100/15 text-white rounded-full pl-3 pr-1.5 py-1.5 shadow-2xl"
    >
      <div className="hidden sm:flex items-center gap-1.5 text-[11px] uppercase tracking-wider text-amber-200/90 pr-2 border-r border-white/15">
