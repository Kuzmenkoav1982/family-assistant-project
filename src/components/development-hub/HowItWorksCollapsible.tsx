...
const STEPS = [
  ...
  { icon: 'MessagesSquare', title: 'Шаг 3. Диалог', text: 'Семейный ИИ-помощник, техники релаксации, упражнения для семьи и справочник кризисов. Бережный собеседник для тонких вопросов.' },
