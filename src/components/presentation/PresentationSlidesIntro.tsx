        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <div className="bg-amber-50 rounded-2xl p-5 border-l-4 border-amber-400">
            <p className="font-semibold text-amber-900 mb-2">
              Поддержка семьи — государственный приоритет до 2036 года
            </p>
            <p className="text-sm text-amber-800">
              Утверждена Стратегия действий в интересах семейной и демографической политики РФ до 2036 года
            </p>
          </div>
          ...
          <div className="pt-2 border-t border-gray-200 mt-2">
            <p className="text-xs text-gray-400 leading-relaxed">
              ...
              Стратегия действий в интересах семейной и демографической политики РФ до 2036 года (утверждена в ноябре 2024 г., представлена Председателем Совета Федерации В.И. Матвиенко); 
