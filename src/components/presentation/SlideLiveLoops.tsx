...
const LOOPS = [
  ...
  },
  {
    ...
    toIcon: 'Wallet',
    toColor: 'bg-emerald-100 text-emerald-700',
    title: 'Расход «оплачено» → бюджет «Развлечения»',
    desc: 'При статусе «оплачено» расход поездки автоматически попадает в общий бюджет. Поддержка мультивалютности и обменного курса.',
    status: 'live',
  },
  {
    from: 'Гараж',
