    ...
    <section data-pdf-slide className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-8 md:p-10 mb-6 sm:mb-8">
      ...
      <div className="bg-gradient-to-r from-slate-50 to-slate-100 rounded-2xl p-5 border-l-4 border-slate-600 mb-5">
        <p className="text-slate-800 text-sm leading-relaxed">
          Первая аудитория, на которой мы запускаем платформу — <strong>семьи военнослужащих и участников СВО</strong>.
          Это группа с максимальной концентрацией мер государственной поддержки и с критической потребностью
          в координации семьи, информировании о льготах и сопровождении в особых жизненных ситуациях.
        </p>
      </div>
