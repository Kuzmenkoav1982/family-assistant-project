...
const FOUNDATION: CardItem[] = [
  ...
  },
  {
    ...
    fullDesc:
      'Согласия, журнал доступа к данным, право на удаление.',
  ...
  },
  {
    ...
    icon: 'BadgeCheck',
    status: 'live',
    shortDesc: 'Минцифры · №34764',
    fullDesc:
      '«Наша Семья» включена в Единый реестр российских программ для ЭВМ и баз данных — реестровая запись №34764 от 18.08.2026. Открывает B2G-контракты, участие в госзакупках и льготу по НДС.',
    note: 'Включено 18.08.2026',
    statusLabel: 'В реестре №34764',
  },
  {
    name: 'Аналитика',
    icon: 'BarChart3',
...
const CHANNELS: CardItem[] = [
  ...
  },
  {
    ...
    fullDesc:
      'Семья получает уведомления и ставит задачи через мессенджер MAX. Голосовой ввод задач, передача чек-листов.',
    note: 'Уже работает',
  },
  {
    name: 'Веб-приложение',
  ...
  },
  {
    ...
    fullDesc:
      'Интеграция в корпоративные HR-порталы: корпоративная семейная программа для сотрудников, отчётность работодателям.',
    note: 'Канал B2B2C',
  },
  {
