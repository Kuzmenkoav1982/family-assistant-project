...
const executionProofs = [
  ...
  },
  {
    ...
    desc: 'Российская инфраструктура, 152-ФЗ, включение в Реестр российского ПО (запись №34764), архитектура под СМЭВ/ЕСИА',
  },
  {
    icon: 'Layers3',
...
const nextProofs = [
  ...
  'Первый B2G-пилот на базе включения в Реестр российского ПО',
