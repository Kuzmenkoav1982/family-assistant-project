        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-black leading-tight">
              Портфолио развития ребёнка
            </h2>
            <p className="text-base md:text-lg text-white/90 mt-2">
              Живая карта по 8 сферам. Не диагноз, не ярлык — карта, по которой растёт ребёнок
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 md:p-10 space-y-6">
        ...
        <div className="bg-gradient-to-br from-slate-900 to-emerald-900 rounded-2xl p-5 md:p-6 text-white">
          ...
          <p className="text-sm text-emerald-100 leading-relaxed mb-3">
            Спокойствие родителя — главная ценность, за которую платят. Ни один конкурент в РФ не
            строит карту развития по данным семьи с прозрачностью источников и этикой
            «карта, а не диагноз». Это удержание + LTV + основа для образовательного B2B.
          </p>
