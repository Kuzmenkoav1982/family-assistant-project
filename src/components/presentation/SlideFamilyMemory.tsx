...
const investorBullets = [
  'Долгий жизненный цикл семейного архива и десятилетний горизонт удержания',
  'Межпоколенческий сценарий: ценность растёт по мере накопления',
  'Естественное расширение внутри семьи: альбом доступен всем участникам, каждый новый член семьи — новый активный пользователь',
  'Накопительный граф семейной памяти и связей: чем дольше семья пользуется, тем глубже встроенность продукта',
];
      ...
      <div className="bg-gradient-to-br from-amber-600 via-orange-600 to-rose-600 p-8 md:p-12 text-white">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm uppercase tracking-wider text-amber-100/90 mt-2 font-semibold">
              Семейный архив значимых моментов
            </p>
            <p className="text-base md:text-lg text-white/90 mt-3">
              Не «ещё один Google Photos для семьи», а осознанный семейный архив. Решает главную
      ...
      <div className="p-6 md:p-10 space-y-6">
        ...
        <div className="bg-gradient-to-br from-slate-900 to-amber-900 rounded-2xl p-5 md:p-6 text-white">
          ...
          <p className="text-sm text-amber-100 leading-relaxed mb-3">
            «Альбом поколений» — модуль с одним из самых длинных горизонтов удержания на рынке.
            Семейный архив традиционно передаётся между поколениями: дети, внуки, правнуки. Это
            создаёт редкую для digital-продуктов комбинацию: длинный жизненный цикл, естественный
            межпоколенческий сценарий и накопительный permissioned family graph, который усиливается
            со временем использования.
          </p>
