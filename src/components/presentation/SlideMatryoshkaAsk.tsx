...
const ROWS: AskRow[] = [
  ...
  },
  {
    ...
    built: 'Web-приложение и MAX-бот в продакшене, включение в Реестр российского ПО (№34764)',
    toBuild: 'Интеграция с Госуслугами и Соцказной, региональный API',
    result: '1 регион + 1 партнёрский пилот за 6–12 мес на базе статуса в Реестре РПО',
  },
];
