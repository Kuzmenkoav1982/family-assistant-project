...
const ROWS: AskRow[] = [
  ...
  },
  {
    ...
    built: 'Web-приложение и MAX-бот в продакшене, заявка в Реестр российского ПО подана',
    toBuild: 'Интеграция с Госуслугами и Соцказной, региональный API',
    result: '1 регион + 1 партнёрский пилот за 6–12 мес, включение в Реестр российского ПО',
  },
];
