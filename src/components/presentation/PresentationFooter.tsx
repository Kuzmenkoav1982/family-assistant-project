      ...
      <section data-pdf-slide className="bg-gradient-to-br from-purple-600 to-indigo-700 rounded-3xl shadow-2xl p-5 sm:p-10 mb-8 text-white">
        <div className="text-center space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-left max-w-2xl mx-auto">
            {[
              'Комплексная российская семейная платформа в production',
              '12 продуктовых хабов · 74 раздела жизни семьи в одном приложении',
              '«Альбом поколений» — семейный архив значимых моментов между поколениями',
              '«Портфолио развития» — карта по 8 сферам для каждого члена семьи (карта, а не оценка)',
              'AI-ассистент «Домовой» + голосовое управление (Алиса)',
              'Платформа в цифрах: 146+ UI/бизнес-модулей · 90+ API-эндпоинтов · 150+ таблиц данных',
              'Полностью российский продукт — в Реестре российского ПО (запись №34764)',
