export const sections = [
  ...
  {
    title: 'Праздники',
    description: 'Планирование праздников с бюджетом, гостями, подарками',
    icon: 'PartyPopper',
  ...
  {
    title: 'Голосования',
    description: 'Принимайте семейные решения вместе через голосование',
    icon: 'Vote',
...
export const trackSectionClick = async (sectionIndex: number, sectionTitle: string) => {
  try {
