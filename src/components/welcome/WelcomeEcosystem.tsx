...
function Ring() {
  ...
  return (
    <svg viewBox="0 0 500 500" className="w-full max-w-[480px] mx-auto">
      ...
      <circle cx={cx} cy={cy} r={135} fill="white" filter="url(#shadowEco)" />
      <defs>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-3xl shadow-xl p-6 sm:p-10">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-12 h-12 rounded-2xl flex items-center justify-center bg-gradient-to-br from-purple-500 to-blue-600 flex-shrink-0">
