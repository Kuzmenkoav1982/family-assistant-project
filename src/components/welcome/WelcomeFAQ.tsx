...
const faqs = [
  ...
  },
  {
    ...
    a: 'В бесплатном тарифе доступно 2 члена семьи. На Premium-тарифе количество участников не ограничено. Каждый получает личный профиль с индивидуальными настройками и доступом к общим разделам.',
  },
  {
