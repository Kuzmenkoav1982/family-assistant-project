...
const CONTEXT_TEXT: Record<HowToReadPopoverProps['context'], { title: string; body: string }> = {
  ...
  highlights: {
    ...
    body: 'Здесь — три ориентира: сильная сторона, точка внимания и активный фокус. Это не оценка человека, а подсказка, на чём имеет смысл сосредоточиться по сегодняшним данным семьи.',
  },
  table: {
