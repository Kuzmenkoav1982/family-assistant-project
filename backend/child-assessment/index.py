...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    spend_result = wallet_spend(user_id, family_id, PRICE, 'ai_child_assessment', 'Оценка развития ребёнка ИИ')
    ...
    print(f"[wallet] Charged {PRICE} rub for ai_child_assessment")
