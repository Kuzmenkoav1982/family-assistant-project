...
> **🔒 STATUS: FROZEN** · Commit `2135101` · Date 2026-05-14
>
> Goals V1 принят human visual pass'ом без блокеров. Любые дальнейшие изменения в SMART / OKR / Wheel / Hub / Weekly Review / Focus V1·V2·V2.1 — только через P0/P1 баг-фиксы. Новый scope — отдельный V2 трек.
